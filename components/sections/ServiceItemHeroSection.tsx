        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="max-w-[800px]">
            <h1 className="font-semibold text-[19px] md:text-[48px] leading-[138%] mb-4 md:mb-[25px]">
              ИТ-аутсорсинг —  ваш удаленный ИТ-отдел от 30 000 / мес.
            </h1>
            <p className="font-normal text-[12px] md:text-[22px] leading-[138%] mb-4   md:mb-[40px]">
              Оптимизируем бизнес-процессы, применяя лучшие мировые практики
